...
export class Request {
  ...
  private static accessToken = this.getLocalStorageTokens("accessToken")
  private static refreshToken = this.getLocalStorageTokens("refreshToken")
  ...
  static async getEndpointUrl(payload: NewLocationDto | NewItemDto | NewRoomDto) {
